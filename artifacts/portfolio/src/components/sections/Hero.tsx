  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-muted-foreground font-mono text-xs cursor-pointer hover:text-primary transition-colors"
